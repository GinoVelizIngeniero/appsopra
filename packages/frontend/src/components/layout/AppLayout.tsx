...
import {
  LayoutDashboard, ClipboardList, AlertTriangle, BarChart2,
...
const navItems = [
  ...
  { to: '/adf', label: 'Portal ADF', icon: AlertTriangle, roles: ['USER', 'JEFE_AREA', 'MANTENIMIENTO', 'SUPERVISOR', 'GERENTE', 'ADMIN'] },
  { to: '/confiabilidad', label: 'Confiabilidad', icon: BarChart2, roles: ['JEFE_AREA', 'MANTENIMIENTO', 'SUPERVISOR', 'GERENTE', 'ADMIN'] },
    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <aside className={clsx(
        ...
        <div className="flex items-center gap-3 p-4 border-b border-blue-700 min-h-[64px]">
          ...
          {open && <span className="font-bold text-sm tracking-wide">Portal Sopraval</span>}
          <span className="hidden lg:block font-bold text-sm tracking-wide">Portal Sopraval</span>
        </div>
